...
},{"./maphandler":3,"jquery":1}],3:[function(require,module,exports){
  ...
  updateMarkers = function() {
    ...
    $.getJSON('/api/nearest/'+this.lat+'/'+this.long, function(data){
      $.each( data, function( key, burgerInfo ) {
        console.log('creating marker for ',burgerInfo);
        console.log(context.markers[burgerInfo.burgerID], burgerInfo.burgerID in context.markers);
